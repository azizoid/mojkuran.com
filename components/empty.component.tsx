      ...
      <div className="clearfix">
        <div className="col">
          <h6 className={classes.join(" ")}>
            Kako biste imali <strong>uspješnu</strong> pretragu pratite
            slijedeća <strong>pravila</strong>:
          </h6>
        </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <br />
                Na primjer: Umjesto <code>Mekka</code> napišite{" "}
                <code>Mekku</code> ili <code>Mekke</code>
              </td>
            </tr>
            <tr>
